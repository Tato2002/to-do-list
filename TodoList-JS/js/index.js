...
if(localStorage.getItem("TodosArray")){
    //აქ var იმიტო დავწერე, რომ ბლოქ სკოუპი იყო "let" და ვერ წვდებოდა todoID-ს
...
function CreateTodo(todo) {
    ...
    todoCheck.addEventListener("change", function () {
        if (this.checked) {
            this.nextElementSibling.innerText = "შესრულდა"
            ...
            this.nextElementSibling.innerText = "არ შესრულებულა"
